...
#### 2.Model training
Open "[keypoint_classification.ipynb](gesture_classification.ipynb)" in Jupyter Notebook and execute from top to bottom.<br>
...
#### X.Model structure
The image of the model prepared in "[keypoint_classification.ipynb](gesture_classification.ipynb)" is as follows.
